        ...
        <div className="container relative py-24 md:py-32 lg:py-40 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center space-y-8 max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
              ...
              <span className="text-sm font-medium text-primary">Nieuw: Deel je recepten met de wereld!</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Ontdek duizenden heerlijke recepten, deel je eigen creaties en word onderdeel van een groeiende community van kookliefhebbers
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button size="lg" variant="outline" asChild className="text-lg px-8 h-14 border-2">
                <Link href="/signup">
            ...
            <div className="grid grid-cols-3 gap-8 pt-12 w-full max-w-2xl">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground mt-1">Recepten</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-primary">500+</div>
                <div className="text-sm text-muted-foreground mt-1">Gebruikers</div>
              </div>
              <div className="text-center">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Alles wat je nodig hebt om je kookavontuur te beginnen en je culinaire vaardigheden te verbeteren
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              <CardHeader className="space-y-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-base">
                    Vind het perfecte recept op basis van ingrediënten, type gerecht, bereidingstijd en meer
                  </CardDescription>
                </div>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg group">
              <CardHeader className="space-y-4">
                ...
                <div>
                  <CardTitle className="text-xl mb-2">Deel je Recepten</CardTitle>
                  <CardDescription className="text-base">
                    Maak je eigen recepten aan en deel ze met de community. Word een ster in de keuken!
                  </CardDescription>
                </div>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg group">
              <CardHeader className="space-y-4">
                ...
                <div>
                  <CardTitle className="text-xl mb-2">Gedetailleerde Instructies</CardTitle>
                  <CardDescription className="text-base">
                    Stap-voor-stap bereidingswijze met ingrediëntenlijst en handige tips voor succes
                  </CardDescription>
                </div>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg group">
              <CardHeader className="space-y-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-base">
                    Een frisse, intuïtieve interface met dark mode speciaal ontworpen voor Gen Z
                  </CardDescription>
                </div>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg group">
              <CardHeader className="space-y-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-base">
                    Ontdek recepten van andere kookliefhebbers en laat je inspireren
                  </CardDescription>
                </div>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-lg group">
              <CardHeader className="space-y-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-base">
                    Beheer al je recepten op één plek en heb ze altijd bij de hand
                  </CardDescription>
                </div>
              </CardHeader>
            </Card>
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
              ...
              <span className="text-sm font-medium text-primary">Hoe werkt het?</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="relative text-center">
              ...
              <p className="text-muted-foreground">
                Registreer je gratis in 30 seconden en krijg direct toegang tot alle recepten
              </p>
            </div>
            ...
            <div className="relative text-center">
              ...
              <p className="text-muted-foreground">
                Zoek en filter door duizenden recepten en vind je perfecte gerecht
              </p>
            </div>
            ...
            <div className="relative text-center">
              ...
              <p className="text-muted-foreground">
                Volg de stappen en creëer heerlijke gerechten. Deel je eigen recepten!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-primary to-primary/80 rounded-3xl p-8 md:p-16 lg:p-20 text-center shadow-2xl">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm mb-6">
                ...
                <span className="text-sm font-medium text-white">Gratis voor altijd</span>
              </div>
              ...
              <p className="text-lg md:text-xl text-white/90 mb-10 leading-relaxed">
                Sluit je aan bij duizenden kookliefhebbers en begin vandaag nog met het delen en ontdekken van heerlijke recepten
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild className="bg-white text-primary hover:bg-white/90 text-lg px-8 h-14 shadow-xl">
                  <Link href="/signup">
                    <ChefHat className="mr-2 h-5 w-5" />
                    Gratis aanmelden
                    <ArrowRight className="ml-2 h-5 w-5" />
                ...
                <Button size="lg" variant="outline" asChild className="bg-white/10 border-white/30 text-white hover:bg-white/20 text-lg px-8 h-14 backdrop-blur-sm">
                  <Link href="/recepten">
                    Recepten bekijken
                  </Link>
                </Button>
